...
func Welcome(name string) string {
	...
	var result = fmt.Sprintf("Welcome to my party, %s!", name)
	fmt.Println(result)
	return result
}
...
func HappyBirthday(name string, age int) string {
	...
	var result = fmt.Sprintf("Happy birthday %s! You are now %d years old!", name, age)
	fmt.Println(result)
	return result
}
